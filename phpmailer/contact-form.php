...
if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])) {
	...
	if($responseData->success) {
		...
		$email = 'mihai.linu@netymedia.com';
		...
		try {
			...
			$mail->Username = 'mihai.linu@netymedia.com';                    // SMTP username
			...
			$mail->AddBCC('mihai.linu@netymedia.com');         // Add a "Bcc" address. 
		...
		if ($debug == 0) {
			...
			//}else{
			//	header("Location:contact-form-false.php");
			//}
		}
